          ...
          <div class="row">
			...
			<?php
					...
					if (isset($_POST['submit']))
					{
						...
						if($sql == true)
						{
							echo "<script>window.location = 'profile_parent.php?code=display';</script>";
					...
					if($code == "display")
					{
						echo "<div class='alert alert-success alert-dismissible'>
														<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
														<strong>Thank you!</strong> Your profile is successfully updated.
									</div>";
					}
                ...
                <div class="card-body">
                  ...
                  <form method="post" enctype="multipart/form-data">
					<p class="card-description text-primary">
                      <i class="mdi mdi-account-outline"></i> Update your profile if necessary
                    </p>
					<hr />
                    ...
                    <div class="row">
					  ...
					  <div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="phone_no" value="<?php echo $row[phone_no]; ?>" placeholder="Phone No." required />
						</div>
                      </div>
					  <div class="col-md-3">
						<div class="form-group">
