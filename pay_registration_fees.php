            				...
            				<div class="col-12 grid-margin">
								<div class="card">
									<div class="card-body">
										...
										<input type="hidden" name="parent" value="<?php echo $_SESSION[UserID]; ?>">
										...
										<div id="ob" class="none">
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															<label>Transfer/Bank in <b>RM<?php echo $jumlahKeseluruhanFormat; ?></b> or any amount you willing to pay to the following account:</label><br />
										...
										<div id="cc" class="none">
											<div class="form-body">
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="text-danger">Please provide total amount of <b>RM<?php echo $jumlahKeseluruhanFormat; ?></b> or any amount you willing to pay once you visit our Tahfiz to complete the registration payment. Thank you</label><br />
														</div>
													</div>
												</div>
											</div>
