          ...
          <div class="row">
			...
			<?php
					...
					if (isset($_POST['submit']))
					{
						...
						{
							$sql = mysql_query("UPDATE login SET Password = '$password' WHERE UserID = '$_SESSION[UserID]'");
					...
					$sql = mysql_query("SELECT * FROM owner WHERE username = '$_SESSION[UserID]'");
                ...
                <div class="card-body">
                  ...
                  <form method="post" enctype="multipart/form-data">
					<p class="card-description text-primary">
                      <i class="mdi mdi-lock-outline"></i> It is recommended to update your password once in a while
                    </p>
					<hr />
