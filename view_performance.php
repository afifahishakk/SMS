        ...
        <div class="content-wrapper">
						...
						while($row = mysql_fetch_array($sql))
						{
							...
							while($rowPer = mysql_fetch_array($sqlPer))
							{
								echo "<tr>
									...
									<td>$rowPer[year]</td>
									<td>
															<a href='view_child_hafazan_performance_details.php?student_ic=$row[ic]&name=$row[name]'
		  ...
		  <div class="row">
           ...
           <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Children Academic Performance</h4>
                  <div class="table-responsive">
						...
						while($row = mysql_fetch_array($sql))
						{
							...
							while($rowPer = mysql_fetch_array($sqlPer))
							{
								...
								echo "<tr>
										...
										<td>$rowPer[year]</td>
										<td>
																<a href='view_child_academic_performance_details.php?student_ic=$row[ic]&name=$row[name]'
																data-toggle='tooltip' data-placement='left' title='View'>
																	<i class='mdi mdi-comment-text-outline text-primary'></i>
																</a>
