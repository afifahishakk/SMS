					  ...
					  <div class="modal fade" id="detailsPayment<?php echo $row[payment_id];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							  <div class="modal-dialog">
								<div class="modal-content">
								  ...
								  <form method="post" action="remarkMonthlyPayment.php" enctype="multipart/form-data">
								  ...
								  <input type="hidden" name="existing_paid_amount" value="<?php echo $row[paid_amount]; ?>">
									  ...
									  <div class="modal-body">
												...
												<div class="row">
												  <div class="col-md-6">
													<div class="form-group">
														<label class="font-weight-bold"><span class="mdi mdi-bookmark-check"></span> Month</label>
														<p><?php echo $row[month]; ?></p>
													</div>
												  </div>
												  <div class="col-md-6">
													<div class="form-group">
														<label class="font-weight-bold"><span class="mdi mdi-bookmark-check"></span> Year</label>
